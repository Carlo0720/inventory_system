...
namespace inventory_system.common.Utility
{
    public static class SD
    {
        ...
        #endregion
        #region Order Items
        public const string InsertToOrderItems = "INSERT INTO products (item_name, item_code, item_description, item_color, item_category, supplier, unit, stock, item_price, created_at) " +
